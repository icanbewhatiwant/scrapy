...
#公开招标三个月、今日数据
class ThrMonSpider(scrapy.Spider):
    name = "threeMonthGk"
    ...
    def __init__(self):
        ...
        dispatcher.connect(receiver=self.ThrMonSpiderCloseHandle,
                           signal=signals.spider_closed
                           )

    # 信号量处理函数：关闭chrome浏览器
    def ThrMonSpiderCloseHandle(self, spider):
        print(f"ThrMonSpiderCloseHandle: enter ")
        self.driver.quit()
    ...
    def parse_detail(self, response):
        ...
        key_dict={"采购项目名称":"projectName","品目":"pingmu","采购单位":"purUnit","行政区域":"adminiArea","公告时间":"bulletTime",
                  ...
                  "开标地点":"staLoc","预算金额":"budget","项目联系人":"proContact","项目联系电话":"proPhone","采购单位地址":"purAddress",
